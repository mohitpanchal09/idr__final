...
export const userData = [
    {
        ...
        extra2:"He wanted to go for the Masters in the USA so that can explore the robotics field and after returning from the USA can use skills for Nation. And got admitted to one of the prestigious universities of the USA- The University of Colorado, Boulder. There were two options: either go outside, study, learn and come back to India or stay in India and start a company of my own. So, he chose the second option and started the company IDR Research and Development Pvt Ltd with two more partners",
    },
